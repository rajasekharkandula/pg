            ...
            <div class="col-sm-12">
              <div class="panel panel-default panel-table">
                <div class="panel-heading">Categories
                  <a href="<?php echo base_url('admin/category'); ?>" class="btn btn-primary pull-right"><i class="mdi mdi-plus"></i> Add</a>
                </div>
                  ...
                  <table id="table1" class="table table-striped table-hover table-fw-widget">
                    ...
                    <tbody>
					  ...
					  <tr>
                        ...
                        <td>
							<a href="<?php echo base_url('admin/category/'.$c->id); ?>" class="btn btn-primary"><i class="mdi mdi-edit"></i></a>
							<button class="btn btn-danger remove" data-id="<?php echo $c->id; ?>"><i class="mdi mdi-delete"></i></button>
						</td>
                      </tr>
                      <?php $i++; } ?>
                    </tbody>
