        ...
        <div class="main-content container-fluid">
            ...
            <div class="col-md-12">
              <div class="panel panel-default panel-border-color panel-border-color-primary">
                <div class="panel-heading panel-heading-divider">Shopping Assistant Page Configuration</span></div>
                <div class="panel-body">
                  <form class="form-horizontal" id="page_form">
                    
					<div class="form-group">
                      <label class="col-sm-3">Sticky Heading <span>*</span></label>
                      <div class="col-sm-6">
                        <input req="true" type="text" class="form-control" name="stickytext" value="<?php if(isset($page->stickytext))echo $page->stickytext; ?>">
                      </div>
                    </div>
					...
					<div class="form-group">
                      <label class="col-sm-3">Step 1 <span>*</span></label>
                      <div class="col-sm-6">
                        <input req="true" type="text" class="form-control" name="step1" value="<?php if(isset($page->step1))echo $page->step1; ?>">
                      </div>
                    </div>
					
					<div class="form-group">
                      <label class="col-sm-3">Step 2 <span>*</span></label>
                      <div class="col-sm-6">
                        <input req="true" type="text" class="form-control" name="step2" value="<?php if(isset($page->step2))echo $page->step2; ?>">
                      </div>
                    </div>
					
					<div class="form-group">
                      <label class="col-sm-3">Step 3 <span>*</span></label>
                      <div class="col-sm-6">
                        <input req="true" type="text" class="form-control" name="step3" value="<?php if(isset($page->step3))echo $page->step3; ?>">
                      </div>
                    </div>
