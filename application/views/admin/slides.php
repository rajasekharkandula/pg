            ...
            <div class="col-sm-12">
              <div class="panel panel-default panel-table">
                <div class="panel-heading">
					<div class="row">
						<div class="col-md-6">Slides</div>
						<div class="col-md-6 text-right"> 
							<a href="<?php echo base_url('admin/slide_config'); ?>" class="btn btn-primary"><i class="mdi mdi-plus"></i> Add</a>
						</div>
					</div>
                </div>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <div class="text-center">
              ...
              <h3>Delete!</h3>
              <p>Are you sure want to delete slide?</p>
              <div class="xs-mt-50">
