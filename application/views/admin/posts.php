            ...
            <div class="col-sm-12">
              <div class="panel panel-default panel-table">
                <div class="panel-heading">
					<div class="row">
						<div class="col-md-6">Recent Posts</div>
						<div class="col-md-6 text-right"> 
							<a href="<?php echo base_url('admin/post_config'); ?>" class="btn btn-primary"><i class="mdi mdi-plus"></i> Add</a>
						</div>
					</div>
                </div>
                  ...
                  <table id="table1" class="table table-striped table-hover table-fw-widget">
                    ...
                    <tbody>
					  ...
					  <tr>
                        ...
                        <td>
							<a href="<?php echo base_url('admin/post_config/'.$s->id); ?>" class="btn btn-primary"><i class="mdi mdi-edit"></i></a>
