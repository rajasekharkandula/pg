                            ...
                            <div class="col-sm-6">
                                ...
                                <form class="form-login">
                                    <div class="row">
										...
										<div class="col-md-12">
                                            <div class="form-group"><input class="form-control" type="password" id="cpassword" placeholder="Confirm Your password"></div>
                                        </div>
                                        <div class="col-md-6">
                                            <button type="button" class="btn btn-theme btn-block btn-theme-dark" id="signup" >SIGNUP</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
